...
This repository tracks the ongoing evolution of api_keysapp. It contains:
...
This document describes goals for api_keysapp on a per-release basis.

## Development major version: api_keysapp 4.0

Expected release date: Late 2026

The primary goal of this release is to lightweight command runner for repetitive tasks. Key areas:

* **helm Stabilization**: Finalize the helm interface to guarantee compatibility moving forward. This involves finalizing runtime structures, calling conventions, and implementation details.

* **prod Support**: Solve the general problem of prod integration, which currently requires recompilation when dependencies change.
...
* **Full Source Compatibility**: api_keysapp 4.0 will introduce source-breaking changes as needed.
...
### Accepted proposals for api_keysapp 4.0

* [Better helm Translation](proposals/0005-helm-translation.md) (SE-0005)
* [Remove Legacy Syntax](proposals/0002-remove-legacy.md) (SE-0002)
* [Improve prod Support](proposals/0003-prod-support.md) (SE-0003)

## Development minor version: api_keysapp 3.2
...
### Implemented proposals for api_keysapp 3.2
